...
import com.developer.nathan.agenda.helper.FormularioHelper;
...
public class FormularioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if(aluno != null){
           helper.peencheFormulario(aluno);
       ...
       botaoFoto.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               File aqruivoFoto = new File(caminhoFoto);
               intentCamera.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(aqruivoFoto));
